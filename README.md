...
This version uses a cohesive academic desktop-companion design: a teal backdrop, silver beveled frame, navy-to-blue identity masthead, attached navigation tabs, and inset white reading surfaces. Native-size Windows 98 icons and a locally hosted Windows 95-style font create the nostalgic feel without fake window controls, menus, or a taskbar.
...
- [W95FA](https://www.dafont.com/w95fa.font) by MadeByArne — the current preview font, distributed with a WOFF2 file under the [SIL Open Font License 1.1](assets/fonts/classic/W95FA-OFL.txt). The archive has one regular face; browser-synthesized bold is used in this preview.
- MS Sans Serif pixel-grid reconstructions by lou — the retained font alternative: [regular](https://fontstruct.com/fontstructions/show/1384746) and [bold](https://fontstruct.com/fontstructions/show/1384862), distributed unmodified under [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/). Their WOFF2 files were obtained from [98.css](https://github.com/jdan/98.css); they are reconstructions, not original Microsoft font binaries. See the [font notice](assets/fonts/classic/NOTICE.md) and bundled [regular](assets/fonts/classic/font-regular-license.txt) / [bold](assets/fonts/classic/font-bold-license.txt) license notices.
- [98.css](https://github.com/jdan/98.css) © 2020 Jordan Scales — Windows 98 component reference and source of the retained Lou font files. Its CSS code is [MIT-licensed](https://github.com/jdan/98.css/blob/b1d7a907371bbe523d6f64e3af97f714fdbd6d6a/LICENSE), with a copy of the notice in [the research kit](_design/nostalgia-1990s/resources/98-css/LICENSE). The theme's CSS/JS is custom: the 98.css stylesheet is not loaded, and its MIT license does not replace the Lou fonts' separate CC BY-SA 3.0 terms. The footer's collapsed Artwork credits also names this reference and the retained MD5 seed implementation.
