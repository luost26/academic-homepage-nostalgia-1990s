...
- [98.css](https://github.com/jdan/98.css) © 2020 Jordan Scales — Windows 98 component reference and source of the unmodified font files. Its CSS code is [MIT-licensed](https://github.com/jdan/98.css/blob/b1d7a907371bbe523d6f64e3af97f714fdbd6d6a/LICENSE), with a copy of the notice in [the research kit](_design/nostalgia-1990s/resources/98-css/LICENSE). The theme's CSS/JS is custom: the 98.css stylesheet is not loaded, and its MIT license does not replace the fonts' separate CC BY-SA 3.0 terms. The footer's collapsed Artwork credits also names this reference and the retained MD5 seed implementation.
